...
-- Generated: 2025-05-26 03:55:47.638818
-- Table: production_classification_results_20250526_035534
...
FROM production_classification_results_20250526_035534
...
SELECT 
    confidence_level,
    COUNT(*) as count,
    ROUND(COUNT(*) * 100.0 / (SELECT COUNT(*) FROM production_classification_results_20250526_035534), 2) as percentage,
...
FROM production_classification_results_20250526_035534 r
