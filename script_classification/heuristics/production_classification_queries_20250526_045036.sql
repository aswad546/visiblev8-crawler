...
-- Generated: 2025-05-26 04:50:49.005662
-- Table: production_classification_results_20250526_045036
...
FROM production_classification_results_20250526_045036
...
SELECT 
    confidence_level,
    COUNT(*) as count,
    ROUND(COUNT(*) * 100.0 / (SELECT COUNT(*) FROM production_classification_results_20250526_045036), 2) as percentage,
...
FROM production_classification_results_20250526_045036 r
